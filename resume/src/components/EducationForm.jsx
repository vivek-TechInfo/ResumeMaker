import { GraduationCapIcon, Plus, SparklesIcon, Trash2 } from 'lucide-react';
                ...
                data.map((education , index)=>(
                    <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className="grid md:grid-cols-2 gap-3">
                            ...
                            <input value={education.graduation_date || ""} onChange={(e)=> updateEducation(index,"graduation_date" , e.target.value)} placeholder='Enter the Date' type="month"   className="px-3 py-2 text-sm  disabled:bg-gray-100"  />

                        </div>

                            <input value={education.gpa || ""} onChange={(e)=> updateEducation(index,"gpa" , e.target.value)} type="text" placeholder='GPA (optional)'   className="px-3 py-2 text-sm  disabled:bg-gray-100"  />
