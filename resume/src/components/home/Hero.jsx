...
const Hero = () => {
  ...
  return  <>
            <div className="min-h-screen pb-20">
                {/* Navbar */}
                <nav className="z-50 flex items-center justify-between w-full h-16 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    <a href="/">
                    <img src="/logo.svg" alt="logo" className="h-20 text-center w-auto" />
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link to={"/app"} hidden={!user}  className="hidden md:block px-8 py-2 bg-blue-500 hover:bg-blue-700 active:scale-95 transition-all rounded-full text-white"  >Dashborad</Link>
                    </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                         AI-powered resumes that get you <span className=" bg-gradient-to-r from-yellow-700 to-yellow-600 bg-clip-text text-transparent text-nowrap">hired </span> faster.
                    </h1>

                    <p className="max-w-md text-center text-base my-7">Don’t wait for opportunities — create them. Build a professional resume that gets noticed and land interviews faster.</p>

                    {/* CTA Buttons */}
                    <div className="flex items-center gap-4 ">
                        <Link hidden={user} to='/app' className="bg-green-500 hover:bg-yellow-600 text-white rounded-full px-9 h-12 m-1 ring-offset-2 ring-1 ring-yellow-400 flex items-center transition-colors">
                            Get started
