                ...
                data.map((project , index)=>(
                    <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                        ...
                        <div className="grid  gap-3">
                            ...
                            <textarea value={project.description || ""} onChange={(e)=>updateProject(index,"description" , e.target.value)} rows={4}  className="w-full border-3 focus:border-green-700 text-sm px-3 py-2 rounded-lg resize-none" placeholder="Describe your project"/>
                    </div>
                ))
            }
