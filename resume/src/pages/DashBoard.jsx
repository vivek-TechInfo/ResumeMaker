...
const DashBoardPage = () => {
  ...
  const colors = ["#9333ea", "#d97706", "#dc2662", "#0284c7", "#16a34f"];
  ...
  // console.table(showCreateResume, showUploadResume, title, resume);
  ...
  const handleOnSubmitCreateResume = async (e) => {
  ...
  const handleOnSubmitUploadResume = async (e) => {
    e.preventDefault();
    setIsLoading(true)
  ...
  const handleOnSubmitEditTitle = async (e) => {
    e.preventDefault();
    ...
    try {
        ...
        //  navigate(`/app/builder/${data.resume_id}`);
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          >
            ...
            <p className="text-sm group-hover:text-purple-600 transition duration-300">
              Create Resume
            </p>
          </button>
        ...
        {showCreateResume && (
          <form
            onSubmit={handleOnSubmitCreateResume}
        ...
        {showUploadResume && (
          <form
            onSubmit={handleOnSubmitUploadResume}
