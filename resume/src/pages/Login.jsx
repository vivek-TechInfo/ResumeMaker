...
const LoginPage = () => {
  ...
  return (
    <div id="login" className="flex items-center justify-center bg-gray-100 min-h-screen">
      <div>
              <form
      ...
      >
        ...
        <button
          type="submit"
          className="mt-2 w-full h-11 rounded-full text-white bg-yellow-600 hover:opacity-90 transition-opacity"
        >
          {state === "login" ? "Login" : "Sign up"}
        </button>
        <p
